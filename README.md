...
- [实现说明书](docs/ARCHITECTURE.md) —— 当前代码的实际实现（网页版：[architecture.html](docs/architecture.html)）
...
八套版本化评测集，各自记录了可比较的基线和合入门槛，详见 [tests/evals/README.md](tests/evals/README.md)：
